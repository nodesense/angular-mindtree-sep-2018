...
fdescribe('ProductService', () => {
  ...
  it('should return good response with data', (done) => {
    ...
    const productsRequest = httpMock.expectOne('http://localhost:7070/api/products');
  ...
  it('should return good one product', (done) => {
    ...
    const productsRequest = httpMock.expectOne('http://localhost:7070/api/products/100');
